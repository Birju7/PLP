...
public class Validate {
	...
	public static String validateMobileNumber(String mobileNumber)
	{
		...
		if (!(mat.find() && mat.group().equals(mobileNumber)))
			throw new PizzaException("Enter a valid mobile number");
		return mobileNumber;
	 ...
	 */
	public static String validateEmail(String email) throws PizzaException {

		String emailRegex = "^[a-zA-Z0-9_+&*-]+(?:\\." + "[a-zA-Z0-9_+&*-]+)*@"
				+ "(?:[a-zA-Z0-9-]+\\.)+[a-z" + "A-Z]{2,7}$";
		Pattern pat = Pattern.compile(emailRegex);
		if (email == null)
			throw new PizzaException("Enter a valid email address");
...
//		and the length should be between 6-10 characters.
		...
		if (!(pat.matcher(password).matches()))
			throw new PizzaException("Enter a password which contains 1 small case, 1 capital, 1 special character"
	...
	public static boolean validateCheckInCheckOutDate(LocalDate checkIn,
			LocalDate checkOut) throws PizzaException {
		if (checkIn.isAfter(checkOut))
			throw new PizzaException("CheckOut date should after checkIn date");
		return true;
	}
	...
	public static String isStringOnlyAlphabet(String input)
		...
		if ((!input.equals("")) && (input != null)
			...
			throw new PizzaException("Name can contain only alphabets");
	}

	public static String isUsernameValid(String input) throws PizzaException {
